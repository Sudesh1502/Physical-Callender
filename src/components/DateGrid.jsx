...
export default function DateGrid({
  ...
  const handleDayClick = (day) => {
    ...
    const isDoubleTap =
      ...
      isSameDay(day, lastClickRef.current.day);
            ...
            >
              ...
              <button
                className={twMerge(
                  ...
                  tagType === "holiday" && !isSelected
                    ? "bg-red-500 text-white shadow-md"
                    : "",
                  tagType === "custom" && !isSelected
                    ? "bg-blue-500 text-white shadow-md"
                    : "",
                  !sameMonth && !isSelected && !tagType
                    ? "text-slate-300 font-normal"
                    : "",
                  sameMonth && !isSelected && !today && !tagType
                    ? "text-slate-700"
                    : "",
                  today && !isSelected && !tagType
